        ...
        return (
            <g transform={transform}>
                ...
                <text is visibility={visibility} transform={transformText}>
                    ...
                    <tspan is x="0" text-anchor="middle" dy="25" font-size="20px" fill="#a9f3ff">{this.props.tooltip.data.value+" people"}</tspan>
                </text>
            </g>
        );
    }
...
var LineChart=React.createClass({
    ...
    getInitialState:function(){
        return {
            tooltip:{ display:false,data:{key:'',value:'', start_time:'01-01-2016', end_time:'12-31-2016'}},
