// Data to display
// Advocates: services requested, amount of Advocates. Can sort by time and Advocates
// Alerts: advocate, items. can sort by time, response, advocate, 
// age, gender, Cambodian pharmacutical company. swollotail, 

import React from 'react';
import {render} from 'react-dom';
import ReactDOM from 'react-dom';
import Chart1 from './Chart';
import Donute from './DonuteChart';
						...
						<div className="row x_title">
							...
							<div className="col-md-3 col-sm-3 col-xs-12 bg-white">
								...
								<div className="col-md-12 col-sm-12 col-xs-6">
									<div>
										<i className="fa fa-bar-chart"></i><a href="#">Auto Renewal</a>
									</div>
									<div>
										<i className="fa fa-bar-chart"></i><a href="#">Auto Renewal</a>
									</div>
